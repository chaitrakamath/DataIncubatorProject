#File: Q3_Python.py
#Description: Extract data about Python meetups around different cities
#Date: Jan 30th, 2016
...
api_key = 'my_api_key'
cities = ['Austin', 'Houston', 'San Francisco', 'San Jose', 'Los Angeles', 'San Diego','Seattle', 'Portland', 'Hillsboro', 'Melbourne', 'Adelaide','Sydney', 'Perth', 'Brisbane', 'New Castle', 'Mumbai', 'Delhi', 'Bangalore', 'Beijing', 'Shanghai', 'Hong Kong', 'Toronto', 'Vancouver', 'Montreal', 'Quebec City', 'Ottowa', 'Calgary', 'Hamilton', 'London', 'Manchester', 'Birmingham','Liverpool', 'Edinburgh', 'Cardiff', 'Sheffield','Nottingham', 'Paris', 'Amsterdam', 'Berlin', 'Hamburg', 'Munich', 'Frankfurt', 'Stuttgart', 'Bremen', 'Cologne']
...
def extract_data():
	for c in cities:
		...
		while (num_output_records == per_page):
			...
			response = load_results({'lat': latitude, 'lon': longitude, 'radius': 25, 'offset': offset, 'key': api_key, 'topic': topic})
		...
		results_df.to_csv('Python_Meetup_Data.csv')
		time.sleep(1)
